        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mt-[20px]">
            <input
              ...
              className="w-full px-3 py-2 bg-custom-blue rounded placeholder-opacity-50 focus:outline-none cursor-pointer"
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-custom-blue rounded placeholder-opacity-30 focus:outline-none mt-[24px] cursor-pointer"
          ...
          <div className="flex flex-col items-center justify-center mt-[20px] gap-[24px]">
            <button
              type="submit"
              className="bg-custom-red pt-[15px] pb-[15px] rounded-[6px] w-[279px] h-[48px] text-white font-normal cursor-pointer hover:bg-[#FFFFFF] hover:text-[#161D2F]"
            >
